-- This query inserts data into the actors table based on the data from the previous year (1913) and the current year (1914).
INSERT INTO actors (actor_id, actor, films, quality_class, is_active, current_year)
-- CTE 'last_year_data' selects data from the previous year (1913) from the actors table.
